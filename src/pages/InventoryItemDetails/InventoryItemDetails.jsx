...
class InventoryItemDetails extends Component {
    ...
    render(){
        ...
        const { description, itemName, category, status, quantity, warehouseName } = inDetails;
                ...
                <section className='item-details__wrap'>
                    <article className='item-details__header'>
                        <section className='item-details__subheader' >
                            <Link to="/inventory" >
                                <img className='item-details__firstIcon' 
                                src={backarrow} 
                                alt="arrow to go back to last page" 
                                />
                            </Link>
                            <h1 className='item-details__pageheader' >
                                {itemName}
                            </h1>
                        </section>
                        <Link className="item-details__edit-link" to={`/InventoryEdit/${this.Id}`}>
                            <div className="item-details__edit">
                                <img className='item-details__secondIcon' 
                                src={editpage} 
                        ...
                        <article className='item-details__bodyHeader'>
                            <div className="item-details__description">
                                ...
                                <p className="item-details__bodyText" >
                                {description}
                                </p>
                            </div>
