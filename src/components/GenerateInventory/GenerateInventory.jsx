...
export default function GenerateInventory({ inventory }) {
  return (
    <>
      <div className="container__inventory">
        <ul className="inventory">
        <div className="inventory__header">
            <p>INVENTORY ITEM <img  className='inventory__header-svg' src={sort} alt="sort"/> </p>
            <p>CATEGORY <img className='inventory__header-svg' src={sort} alt="sort"/> </p>
            <p>STATUS <img  className='inventory__header-svg' src={sort} alt="sort"/> </p>
            <p>QUANTITY <img className='inventory__header-svg' src={sort} alt="sort"/> </p>
            <p>ACTIONS</p>
          </div>
